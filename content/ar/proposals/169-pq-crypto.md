...
قم بتحديث الأقسام والجداول في وثيقة الهياكل المشتركة [/en/docs/specs/common-structures/](/en/docs/specs/common-structures/) كما يلي:
...
قم بتحديث مواصفات ECIES-Ratchet [/en/docs/specs/ecies/](/en/docs/specs/ecies/) كما يلي:
...
لاحظ أنه بينما ستحتوي الرسالة 2 عادةً على حمولة غير صفرية، فإن مواصفات ratchet [/en/docs/specs/ecies/](/en/docs/specs/ecies/) لا تتطلب ذلك، لذا فإن الحد الأدنى لحجم الحمولة هو 0. يمكن حساب الأحجام الدنيا للرسالة 2 وفقاً لذلك.

### التوقيع

قم بتحديث مواصفات NTCP2 [/en/docs/specs/ntcp2/](/en/docs/specs/ntcp2/) كما يلي:
...
حدّث مواصفات SSU2 [/en/docs/specs/ssu2/](/en/docs/specs/ssu2/) كما يلي:
