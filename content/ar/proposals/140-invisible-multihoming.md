...
يحدد هذا الاقتراح تصميماً لبروتوكول يمكّن عميل I2P أو خدمة أو عملية موازن خارجي من إدارة عدة routers بشفافية تستضيف [Destination](http://localhost:63465/en/docs/specs/common-structures/#destination) واحد.

الاقتراح حالياً لا يحدد تنفيذاً محدداً. يمكن تنفيذه كإضافة لـ [I2CP](/en/docs/specs/i2cp/)، أو كبروتوكول جديد.
...
لإنشاء وإدارة هذا التكوين، يحتاج العميل إلى الوظائف الجديدة التالية بالإضافة إلى ما يوفره حالياً [I2CP](/en/docs/specs/i2cp/):
