...
تحتوي مواصفاتنا [SSU](/en/docs/transport/ssu/) و[SSU-SPEC](/en/docs/specs/ssu/) على أخطاء وعدم تناسق بشأن ما إذا كانت
...
توضح مواصفاتنا [SSU](/en/docs/transport/ssu/) و[SSU-SPEC](/en/docs/specs/ssu/) بوضوح أن
...
[SSU-SPEC](/en/docs/specs/ssu/) يقول حاليًا (طلب التوجيه):
...
[SSU-SPEC](/en/docs/specs/ssu/) يقول حاليًا (استجابة التوجيه):
...
[SSU-SPEC](/en/docs/specs/ssu/) يقول حاليًا (مقدمة التوجيه):
