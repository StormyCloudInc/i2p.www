...
يُترك التسليم المضمون للطبقات العليا مثل [Streaming library](/spec/api/streaming/). يجب على التطبيقات التي تتطلب الموثوقية أن تتولى بنفسها إعادة الإرسال وإقرارات الاستلام.
