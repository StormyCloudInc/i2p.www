...
按照以下方式更新通用结构文档 [/en/docs/specs/common-structures/](/en/docs/specs/common-structures/) 中的章节和表格：
...
按以下方式更新ECIES-Ratchet规范 [/en/docs/specs/ecies/](/en/docs/specs/ecies/)：
...
请注意，虽然消息2通常会有非零载荷，但ratchet规范[/en/docs/specs/ecies/](/en/docs/specs/ecies/)并不要求如此，因此最小载荷大小为0。可以相应地计算消息2的最小大小。

### 签名

按如下方式更新 NTCP2 规范 [/en/docs/specs/ntcp2/](/en/docs/specs/ntcp2/)：
...
按以下方式更新 SSU2 规范 [/en/docs/specs/ssu2/](/en/docs/specs/ssu2/)：
