...
Mettez à jour les sections et tableaux dans le document des structures communes [/en/docs/specs/common-structures/](/en/docs/specs/common-structures/) comme suit :
...
Mettre à jour la spécification ECIES-Ratchet [/en/docs/specs/ecies/](/en/docs/specs/ecies/) comme suit :
...
Notez que bien que le message 2 ait normalement une charge utile non nulle, la spécification ratchet [/en/docs/specs/ecies/](/en/docs/specs/ecies/) ne l'exige pas, donc la taille minimale de charge utile est de 0. Les tailles minimales du message 2 peuvent être calculées en conséquence.

### Signature

Mettez à jour la spécification NTCP2 [/en/docs/specs/ntcp2/](/en/docs/specs/ntcp2/) comme suit :
...
Mettre à jour la spécification SSU2 [/en/docs/specs/ssu2/](/en/docs/specs/ssu2/) comme suit :
