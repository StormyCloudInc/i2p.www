...
Nos spécifications [SSU](/en/docs/transport/ssu/) et [SSU-SPEC](/en/docs/specs/ssu/) contiennent des erreurs et des incohérences concernant le support
...
Nos spécifications [SSU](/en/docs/transport/ssu/) et [SSU-SPEC](/en/docs/specs/ssu/) indiquent clairement que
...
[SSU-SPEC](/en/docs/specs/ssu/) indique actuellement (Réponse de Relais) :
...
[SSU-SPEC](/en/docs/specs/ssu/) indique actuellement (Introduction de Relais) :
