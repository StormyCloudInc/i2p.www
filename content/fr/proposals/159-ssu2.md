...
- Utiliser une poignée de main à 3 messages et un seul aller-retour, comme dans [NTCP2](/en/docs/spec/ntcp2/).
...
* Modèles de menace : À partir de NTCP2 [NTCP2](/en/docs/spec/ntcp2/), avec des menaces supplémentaires significatives
...
* Choix cryptographiques : De [NTCP2](/en/docs/spec/ntcp2/).

* Handshake : Noise XK de [NTCP2](/en/docs/spec/ntcp2/) et [NOISE](https://noiseprotocol.org/noise.html). Des simplifications importantes
  de NTCP2 sont possibles grâce à l'encapsulation (limites de messages inhérentes)
  fournie par UDP.

* Obscurcissement de clé éphémère de poignée de main : Adapté de [NTCP2](/en/docs/spec/ntcp2/)
  mais utilisant ChaCha20 de [ECIES](/en/docs/spec/ecies/) au lieu d'AES.
...
* Obfuscation d'en-tête de paquet : Adapté de [NTCP2](/en/docs/spec/ntcp2/)
  mais utilisant ChaCha20 de [ECIES](/en/docs/spec/ecies/) au lieu d'AES.
...
* En-têtes utilisés comme données associées AEAD comme dans [ECIES](/en/docs/spec/ecies/).
...
* Signatures des données Relay et Peer Test : À partir de la spécification des structures communes [Common](/en/docs/spec/common-structures/)

* Format de bloc : Depuis [NTCP2](/en/docs/spec/ntcp2/) et [ECIES](/en/docs/spec/ecies/).

* Rembourrage et options : À partir de [NTCP2](/en/docs/spec/ntcp2/) et [ECIES](/en/docs/spec/ecies/).
...
Ceci utilise le même format de bloc que défini dans les spécifications [NTCP2](/en/docs/spec/ntcp2/) et [ECIES](/en/docs/spec/ecies/). Les types de blocs individuels sont définis différemment. Le terme équivalent dans QUIC [RFC 9000](https://datatracker.ietf.org/doc/html/rfc9000) est "frames".
...
Il y a un ou plusieurs blocs dans la charge utile chiffrée. Un bloc est un format simple Tag-Length-Value (TLV). Chaque bloc contient un identifiant d'un octet, une longueur de deux octets, et zéro ou plusieurs octets de données. Ce format est identique à celui de [NTCP2](/en/docs/spec/ntcp2/) et [ECIES](/en/docs/spec/ecies/), cependant les définitions de blocs sont différentes.
...
Cela utilise les mêmes 9 octets pour l'en-tête I2NP que dans [NTCP2](/en/docs/spec/ntcp2/) (type, identifiant de message, expiration courte).
...
- La longueur du padding doit être déterminée soit au cas par cas pour chaque message avec des estimations de la distribution de longueur, soit des délais aléatoires doivent être ajoutés. Ces contre-mesures doivent être incluses pour résister à la DPI, car les tailles de messages révéleraient sinon que le trafic I2P est transporté par le protocole de transport. Le schéma exact de padding constitue un domaine de travail futur, l'Annexe A de [NTCP2](/en/docs/spec/ntcp2/) fournit plus d'informations sur le sujet.
