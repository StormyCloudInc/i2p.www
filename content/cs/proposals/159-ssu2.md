...
- Použijte 3-zprávu, jednokolový handshake, jako v [NTCP2](/en/docs/spec/ntcp2/).
...
* Modely hrozeb: Z NTCP2 [NTCP2](/en/docs/spec/ntcp2/), s významnými dodatečnými hrozbami
...
* Kryptografické volby: Z [NTCP2](/en/docs/spec/ntcp2/).

* Handshake: Noise XK z [NTCP2](/en/docs/spec/ntcp2/) a [NOISE](https://noiseprotocol.org/noise.html). Značná zjednodušení
  NTCP2 jsou možná díky enkapsulaci (inherentní hranice zpráv)
  poskytované protokolem UDP.

* Handshake ephemeral key obfuscation: Upraveno z [NTCP2](/en/docs/spec/ntcp2/)
  ale s použitím ChaCha20 z [ECIES](/en/docs/spec/ecies/) místo AES.
...
* Obfuskace záhlaví paketů: Adaptováno z [NTCP2](/en/docs/spec/ntcp2/)
  ale používá ChaCha20 z [ECIES](/en/docs/spec/ecies/) místo AES.
...
* Hlavičky používané jako AEAD associated data jako v [ECIES](/en/docs/spec/ecies/).
...
* Podpisy dat Relay a Peer Test: Ze specifikace společných struktur [Common](/en/docs/spec/common-structures/)

* Formát bloku: Z [NTCP2](/en/docs/spec/ntcp2/) a [ECIES](/en/docs/spec/ecies/).

* Padding a možnosti: Z [NTCP2](/en/docs/spec/ntcp2/) a [ECIES](/en/docs/spec/ecies/).
...
Toto používá stejný formát bloku, jak je definován ve specifikacích [NTCP2](/en/docs/spec/ntcp2/) a [ECIES](/en/docs/spec/ecies/). Jednotlivé typy bloků jsou definovány odlišně. Ekvivalentní termín v QUIC [RFC 9000](https://datatracker.ietf.org/doc/html/rfc9000) je "frames".
...
V šifrovaném payloadu je jeden nebo více bloků. Blok je jednoduchý formát Tag-Length-Value (TLV). Každý blok obsahuje jednobajtový identifikátor, dvoubytovou délku a nula nebo více bajtů dat. Tento formát je identický s formátem v [NTCP2](/en/docs/spec/ntcp2/) a [ECIES](/en/docs/spec/ecies/), nicméně definice bloků se liší.
...
Používá stejných 9 bytů pro I2NP hlavičku jako v [NTCP2](/en/docs/spec/ntcp2/) (typ, message id, krátké vypršení).
...
Toto používá stejných 9 bytů pro I2NP hlavičku jako v [NTCP2](/en/docs/spec/ntcp2/) (typ, id zprávy, krátká expirace).
...
- Délka paddingu má být buď rozhodována na základě jednotlivých zpráv a
  ...
  dokumentu [NTCP2](/en/docs/spec/ntcp2/) poskytuje více informací k tomuto tématu.
