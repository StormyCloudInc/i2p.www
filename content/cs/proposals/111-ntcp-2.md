...
Tento návrh popisuje protokol pro autentizovanou dohodu o klíčích, který má zlepšit odolnost [NTCP](/docs/transport/ntcp/) vůči různým formám automatizované identifikace a útokům.
