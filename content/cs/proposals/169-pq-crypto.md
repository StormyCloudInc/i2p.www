...
Aktualizujte sekce a tabulky v dokumentu běžných struktur [/en/docs/specs/common-structures/](/en/docs/specs/common-structures/) následovně:
...
Aktualizujte specifikaci ECIES-Ratchet [/en/docs/specs/ecies/](/en/docs/specs/ecies/) následovně:
...
Upozorňujeme, že zatímco zpráva 2 bude normálně mít nenulový payload, specifikace ratchet [/en/docs/specs/ecies/](/en/docs/specs/ecies/) to nevyžaduje, takže minimální velikost payload je 0. Minimální velikosti zprávy 2 mohou být vypočítány odpovídajícím způsobem.

### Podpis

Aktualizujte specifikaci NTCP2 [/en/docs/specs/ntcp2/](/en/docs/specs/ntcp2/) následovně:
...
Aktualizujte specifikaci SSU2 [/en/docs/specs/ssu2/](/en/docs/specs/ssu2/) následovně:
