...
Pro většinu aplikací doporučujeme používat [SAM (Simple Anonymous Messaging)](https://geti2p.net/en/docs/api/samv3) nebo [I2CP (I2P Client Protocol)](https://geti2p.net/en/docs/protocol/i2cp). SAM je jednodušší protokol podobný SOCKS a je dostupný v mnoha programovacích jazycích. I2CP poskytuje více možností konfigurace a kontroly, ale je složitější na použití.
