...
- Use a 3-message, one-round-trip handshake, as in [NTCP2](/en/docs/specs/ntcp2/).
...
* Threat models: From NTCP2 [NTCP2](/en/docs/specs/ntcp2/), with significant additional threats
...
* Cryptographic choices: From [NTCP2](/en/docs/specs/ntcp2/).

* Handshake: Noise XK from [NTCP2](/en/docs/specs/ntcp2/) and [NOISE](https://noiseprotocol.org/noise.html). Significant simplifications
  to NTCP2 are possible due to the encapsulation (inherent message boundaries)
  provided by UDP.

* Handshake ephemeral key obfuscation: Adapted from [NTCP2](/en/docs/specs/ntcp2/)
  but using ChaCha20 from [ECIES](/en/docs/specs/ecies/) instead of AES.
...
* Packet header obfuscation: Adapted from [NTCP2](/en/docs/specs/ntcp2/)
  but using ChaCha20 from [ECIES](/en/docs/specs/ecies/) instead of AES.
...
* Headers used as AEAD associated data as in [ECIES](/en/docs/specs/ecies/).
...
* Signatures of Relay and Peer Test data: From the common structures spec [Common](/en/docs/specs/common-structures/)

* Block format: From [NTCP2](/en/docs/specs/ntcp2/) and [ECIES](/en/docs/specs/ecies/).

* Padding and options: From [NTCP2](/en/docs/specs/ntcp2/) and [ECIES](/en/docs/specs/ecies/).
...
This uses the same block format as defined in the [NTCP2](/en/docs/specs/ntcp2/) and [ECIES](/en/docs/specs/ecies/) specifications.
...
This format is identical to that in [NTCP2](/en/docs/specs/ntcp2/) and [ECIES](/en/docs/specs/ecies/),
...
as in [NTCP2](/en/docs/specs/ntcp2/) (type, message id, short expiration).
...
- The padding length is either to be decided on a per-message basis and
  ...
  of [NTCP2](/en/docs/specs/ntcp2/) provides more information on the topic.
