...
resistance of [NTCP](/docs/transport/ntcp/) to various forms of automated identification and attacks.
...
[NTCP](/docs/transport/ntcp/) data is encrypted after the first message (and the first message
