...
Esta proposta descreve um protocolo de acordo de chaves autenticado para melhorar a resistência do [SSU](/en/docs/transport/ssu/) a várias formas de identificação automatizada e ataques.
...
- Suporte SSU 1 e 2 em uma única porta, detecção automática, e publicado como um único
  "transport" (ou seja, RouterAddress) no [NetDB](/en/docs/how/network-database/).
...
- Use um handshake de 3 mensagens e uma viagem de ida e volta, como no [NTCP2](/en/docs/specs/ntcp2/).
  Remove o atraso esperando por mensagens de dados que torna o
  [SSU](/en/docs/transport/ssu/) efetivamente um handshake de duas viagens de ida e volta.
...
- Resistência à DPI à prova de balas... isso seriam transportes plugáveis,
  [Proposta 109](/en/proposals/109-pt-transport/).

- Um transporte baseado em TLS (ou semelhante ao HTTPS)... que seria a [Proposta 104](/en/proposals/104-tls-transport/).
...
A presente proposta tenta fornecer todos os cinco requisitos baseados no protocolo Station-To-Station (STS). Note que este protocolo também é a base para o protocolo [SSU](/en/docs/transport/ssu/).
...
* Modelos de ameaça: Do NTCP2 [NTCP2](/en/docs/specs/ntcp2/), com ameaças adicionais significativas
...
* Escolhas criptográficas: De [NTCP2](/en/docs/specs/ntcp2/).

* Handshake: Noise XK do [NTCP2](/en/docs/specs/ntcp2/) e [NOISE](https://noiseprotocol.org/noise.html). Simplificações significativas
  para o NTCP2 são possíveis devido ao encapsulamento (limites de mensagem inerentes)
  fornecido pelo UDP.

* Ofuscação de chave efêmera do handshake: Adaptado do [NTCP2](/en/docs/specs/ntcp2/)
  mas usando ChaCha20 do [ECIES](/en/docs/specs/ecies/) em vez de AES.
...
* Ofuscação do cabeçalho de pacote: Adaptado do [NTCP2](/en/docs/specs/ntcp2/)
  mas usando ChaCha20 do [ECIES](/en/docs/specs/ecies/) em vez de AES.
...
* Cabeçalhos usados como dados associados AEAD como em [ECIES](/en/docs/specs/ecies/).
...
* Mensagens: Adaptado de [SSU](/en/docs/transport/ssu/)

* Fragmentação I2NP: Adaptado de [SSU](/en/docs/transport/ssu/)

* Relay e Peer Testing: Adaptado de [SSU](/en/docs/transport/ssu/)

* Assinaturas de dados de Relay e Peer Test: Da especificação de estruturas comuns [Common](/en/docs/specs/common-structures/)

* Formato de bloco: De [NTCP2](/en/docs/specs/ntcp2/) e [ECIES](/en/docs/specs/ecies/).

* Padding e opções: De [NTCP2](/en/docs/specs/ntcp2/) e [ECIES](/en/docs/specs/ecies/).
...
Isso usa o mesmo formato de bloco conforme definido nas especificações [NTCP2](/en/docs/specs/ntcp2/) e [ECIES](/en/docs/specs/ecies/). Os tipos de blocos individuais são definidos de forma diferente. O termo equivalente no QUIC [RFC 9000](https://datatracker.ietf.org/doc/html/rfc9000) é "frames".
...
Isto usa os mesmos 9 bytes para o cabeçalho I2NP como em [NTCP2](/en/docs/specs/ntcp2/) (tipo, ID da mensagem, expiração curta).
...
Isso usa os mesmos 9 bytes para o cabeçalho I2NP como no [NTCP2](/en/docs/specs/ntcp2/) (tipo, ID da mensagem, expiração curta).
...
- O comprimento do padding deve ser decidido por mensagem com base em
  ...
  [NTCP2](/en/docs/specs/ntcp2/) fornece mais informações sobre o tópico.
...
Todos os recursos do relay SSU 1 são suportados, incluindo aqueles documentados na [Proposta 158](/en/proposals/158-ipv6-transport-enhancements/) e suportados a partir da versão 0.9.50. Introduções IPv4 e IPv6 são suportadas. Uma Solicitação de Relay pode ser enviada por uma sessão IPv4 para uma introdução IPv6, e uma Solicitação de Relay pode ser enviada por uma sessão IPv6 para uma introdução IPv4.
...
As seguintes propriedades de endereço podem ser publicadas, inalteradas do SSU 1, incluindo mudanças na [Proposta 158](/en/proposals/158-ipv6-transport-enhancements/) suportadas a partir da API 0.9.50:
