...
- Use um handshake de 3 mensagens e uma viagem de ida e volta, como no [NTCP2](/en/docs/spec/ntcp2/).
...
* Modelos de ameaça: Do NTCP2 [NTCP2](/en/docs/spec/ntcp2/), com ameaças adicionais significativas
...
* Escolhas criptográficas: De [NTCP2](/en/docs/spec/ntcp2/).

* Handshake: Noise XK do [NTCP2](/en/docs/spec/ntcp2/) e [NOISE](https://noiseprotocol.org/noise.html). Simplificações significativas
  para o NTCP2 são possíveis devido ao encapsulamento (limites de mensagem inerentes)
  fornecido pelo UDP.

* Ofuscação de chave efêmera do handshake: Adaptado do [NTCP2](/en/docs/spec/ntcp2/)
  mas usando ChaCha20 do [ECIES](/en/docs/spec/ecies/) em vez de AES.
...
* Ofuscação do cabeçalho de pacote: Adaptado do [NTCP2](/en/docs/spec/ntcp2/)
  mas usando ChaCha20 do [ECIES](/en/docs/spec/ecies/) em vez de AES.
...
* Cabeçalhos usados como dados associados AEAD como em [ECIES](/en/docs/spec/ecies/).
...
* Assinaturas de dados de Relay e Peer Test: Da especificação de estruturas comuns [Common](/en/docs/spec/common-structures/)

* Formato de bloco: De [NTCP2](/en/docs/spec/ntcp2/) e [ECIES](/en/docs/spec/ecies/).

* Padding e opções: De [NTCP2](/en/docs/spec/ntcp2/) e [ECIES](/en/docs/spec/ecies/).
...
Isso usa o mesmo formato de bloco conforme definido nas especificações [NTCP2](/en/docs/spec/ntcp2/) e [ECIES](/en/docs/spec/ecies/). Os tipos de blocos individuais são definidos de forma diferente. O termo equivalente no QUIC [RFC 9000](https://datatracker.ietf.org/doc/html/rfc9000) é "frames".
...
Isto usa os mesmos 9 bytes para o cabeçalho I2NP como em [NTCP2](/en/docs/spec/ntcp2/) (tipo, ID da mensagem, expiração curta).
...
Isso usa os mesmos 9 bytes para o cabeçalho I2NP como no [NTCP2](/en/docs/spec/ntcp2/) (tipo, ID da mensagem, expiração curta).
...
- O comprimento do padding deve ser decidido por mensagem com base em
  ...
  [NTCP2](/en/docs/spec/ntcp2/) fornece mais informações sobre o tópico.
