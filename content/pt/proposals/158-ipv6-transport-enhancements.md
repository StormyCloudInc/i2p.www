...
Nossas especificações [SSU](/docs/specs/ssu2/) e [SSU-SPEC](/docs/specs/ssu/) contêm erros e inconsistências sobre se
...
Nossas especificações [SSU](/docs/specs/ssu2/) e [SSU-SPEC](/docs/specs/ssu/) deixam claro que
...
[SSU-SPEC](/docs/specs/ssu/) atualmente diz (Solicitação de Retransmissão):
...
[SSU-SPEC](/docs/specs/ssu/) atualmente diz (Resposta de Retransmissão):
...
[SSU-SPEC](/docs/specs/ssu/) atualmente diz (Introdução à Retransmissão):
