...
Nossas especificações [SSU](/en/docs/transport/ssu/) e [SSU-SPEC](/en/docs/specs/ssu/) contêm erros e inconsistências sobre se
...
Nossas especificações [SSU](/en/docs/transport/ssu/) e [SSU-SPEC](/en/docs/specs/ssu/) deixam claro que
...
[SSU-SPEC](/en/docs/specs/ssu/) atualmente diz (Solicitação de Retransmissão):
...
[SSU-SPEC](/en/docs/specs/ssu/) atualmente diz (Resposta de Retransmissão):
...
[SSU-SPEC](/en/docs/specs/ssu/) atualmente diz (Introdução à Retransmissão):
