...
A fase de proposta está encerrada. Consulte [SPEC](/en/docs/spec/ntcp2/) para a especificação oficial. Esta proposta ainda pode ser referenciada para informações de contexto.
