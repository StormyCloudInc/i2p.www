...
Esta proposta descreve um protocolo de acordo de chaves autenticado para melhorar a resistência do [NTCP](/docs/transport/ntcp/) a várias formas de identificação automatizada e ataques.
