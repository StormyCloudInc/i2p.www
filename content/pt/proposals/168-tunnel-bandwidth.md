...
[Tunnel Creation ECIES specification](/en/docs/specs/tunnel-creation-ecies/) a partir da API 0.9.65.
...
Atualize a [especificação da mensagem de construção de túnel ECIES](/en/docs/specs/tunnel-creation-ecies/)
da seguinte forma:
