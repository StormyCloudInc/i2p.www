...
Dieser Vorschlag beschreibt ein authentifiziertes Schlüsselaustauschprotokoll zur Verbesserung der Widerstandsfähigkeit von [SSU](/en/docs/transport/ssu/) gegen verschiedene Formen der automatisierten Identifikation und Angriffe.
...
- Unterstütze SSU 1 und 2 auf einem einzelnen Port, automatische Erkennung, und veröffentlicht als ein einziger
  "Transport" (d.h. RouterAddress) in der [NetDB](/en/docs/how/network-database/).
...
- Verwende einen 3-Nachrichten-, Ein-Roundtrip-Handshake, wie in [NTCP2](/en/docs/specs/ntcp2/).
  Entferne die Verzögerung beim Warten auf Datennachrichten, die
  [SSU](/en/docs/transport/ssu/) effektiv zu einem Zwei-Roundtrip-Handshake macht.
...
- Ein TLS-basierter (oder HTTPS-ähnlicher) Transport... das wäre [Proposal 104](/en/proposals/104-tls-transport/).
...
Der vorliegende Vorschlag versucht, alle fünf Anforderungen basierend auf dem Station-To-Station (STS) Protokoll zu erfüllen. Beachten Sie, dass dieses Protokoll auch die Grundlage für das [SSU](/en/docs/transport/ssu/) Protokoll bildet.
...
* Bedrohungsmodelle: Von NTCP2 [NTCP2](/en/docs/specs/ntcp2/), mit erheblichen zusätzlichen Bedrohungen,
...
* Kryptographische Entscheidungen: Aus [NTCP2](/en/docs/specs/ntcp2/).

* Handshake: Noise XK von [NTCP2](/en/docs/specs/ntcp2/) und [NOISE](https://noiseprotocol.org/noise.html). Erhebliche Vereinfachungen
  gegenüber NTCP2 sind aufgrund der Kapselung (inhärente Nachrichtengrenzen)
  möglich, die UDP bereitstellt.

* Handshake-Verschleierung für temporäre Schlüssel: Angepasst von [NTCP2](/en/docs/specs/ntcp2/),
  aber mit ChaCha20 aus [ECIES](/en/docs/specs/ecies/) anstelle von AES.
...
* Paket-Header-Verschleierung: Adaptiert von [NTCP2](/en/docs/specs/ntcp2/),
  verwendet jedoch ChaCha20 aus [ECIES](/en/docs/specs/ecies/) anstelle von AES.
...
* Header, die als AEAD associated data verwendet werden, wie in [ECIES](/en/docs/specs/ecies/).
...
* Messages: Adaptiert von [SSU](/en/docs/transport/ssu/)

* I2NP-Fragmentierung: Adaptiert von [SSU](/en/docs/transport/ssu/)

* Relay und Peer Testing: Adaptiert von [SSU](/en/docs/transport/ssu/)

* Signaturen von Relay- und Peer-Test-Daten: Aus der Common Structures Spezifikation [Common](/en/docs/specs/common-structures/)

* Block-Format: Von [NTCP2](/en/docs/specs/ntcp2/) und [ECIES](/en/docs/specs/ecies/).

* Padding und Optionen: Von [NTCP2](/en/docs/specs/ntcp2/) und [ECIES](/en/docs/specs/ecies/).
...
Dies verwendet das gleiche Blockformat wie in den [NTCP2](/en/docs/specs/ntcp2/)- und [ECIES](/en/docs/specs/ecies/)-Spezifikationen definiert. Einzelne Blocktypen sind unterschiedlich definiert. Der entsprechende Begriff in QUIC [RFC 9000](https://datatracker.ietf.org/doc/html/rfc9000) ist "frames".
...
Es gibt einen oder mehrere Blöcke in der verschlüsselten Payload. Ein Block ist ein einfaches Tag-Length-Value (TLV) Format. Jeder Block enthält eine ein-Byte-Kennung, eine zwei-Byte-Länge und null oder mehr Datenbytes. Dieses Format ist identisch mit dem in [NTCP2](/en/docs/specs/ntcp2/) und [ECIES](/en/docs/specs/ecies/), jedoch sind die Blockdefinitionen unterschiedlich.
...
Dies verwendet dieselben 9 Bytes für den I2NP-Header wie in [NTCP2](/en/docs/specs/ntcp2/) (Typ, Nachrichten-ID, kurze Ablaufzeit).
...
- Die Padding-Länge soll entweder auf einer Pro-Nachricht-Basis entschieden werden und
  ...
  [NTCP2](/en/docs/specs/ntcp2/) bietet weitere Informationen zu diesem Thema.
...
Alle Funktionen des SSU 1 Relay werden unterstützt, einschließlich derer, die in [Proposal 158](/en/proposals/158-ipv6-transport-enhancements/) dokumentiert und ab Version 0.9.50 unterstützt werden. IPv4- und IPv6-Introductions werden unterstützt. Eine Relay Request kann über eine IPv4-Sitzung für eine IPv6-Introduction gesendet werden, und eine Relay Request kann über eine IPv6-Sitzung für eine IPv4-Introduction gesendet werden.
...
Die folgenden Adresseigenschaften können veröffentlicht werden, unverändert von SSU 1, einschließlich der Änderungen in [Proposal 158](/en/proposals/158-ipv6-transport-enhancements/), die ab API 0.9.50 unterstützt werden:
