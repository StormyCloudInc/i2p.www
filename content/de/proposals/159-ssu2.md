...
- Verwende einen 3-Nachrichten-, Ein-Roundtrip-Handshake, wie in [NTCP2](/en/docs/spec/ntcp2/).
...
* Bedrohungsmodelle: Von NTCP2 [NTCP2](/en/docs/spec/ntcp2/), mit erheblichen zusätzlichen Bedrohungen,
...
* Kryptographische Entscheidungen: Aus [NTCP2](/en/docs/spec/ntcp2/).

* Handshake: Noise XK von [NTCP2](/en/docs/spec/ntcp2/) und [NOISE](https://noiseprotocol.org/noise.html). Erhebliche Vereinfachungen
  gegenüber NTCP2 sind aufgrund der Kapselung (inhärente Nachrichtengrenzen)
  möglich, die UDP bereitstellt.

* Handshake-Verschleierung für temporäre Schlüssel: Angepasst von [NTCP2](/en/docs/spec/ntcp2/),
  aber mit ChaCha20 aus [ECIES](/en/docs/spec/ecies/) anstelle von AES.
...
* Paket-Header-Verschleierung: Adaptiert von [NTCP2](/en/docs/spec/ntcp2/),
  verwendet jedoch ChaCha20 aus [ECIES](/en/docs/spec/ecies/) anstelle von AES.
...
* Header, die als AEAD associated data verwendet werden, wie in [ECIES](/en/docs/spec/ecies/).
...
* Signaturen von Relay- und Peer-Test-Daten: Aus der Common Structures Spezifikation [Common](/en/docs/spec/common-structures/)

* Block-Format: Von [NTCP2](/en/docs/spec/ntcp2/) und [ECIES](/en/docs/spec/ecies/).

* Padding und Optionen: Von [NTCP2](/en/docs/spec/ntcp2/) und [ECIES](/en/docs/spec/ecies/).
...
Dies verwendet das gleiche Blockformat wie in den [NTCP2](/en/docs/spec/ntcp2/)- und [ECIES](/en/docs/spec/ecies/)-Spezifikationen definiert. Einzelne Blocktypen sind unterschiedlich definiert. Der entsprechende Begriff in QUIC [RFC 9000](https://datatracker.ietf.org/doc/html/rfc9000) ist "frames".
...
Es gibt einen oder mehrere Blöcke in der verschlüsselten Payload. Ein Block ist ein einfaches Tag-Length-Value (TLV) Format. Jeder Block enthält eine ein-Byte-Kennung, eine zwei-Byte-Länge und null oder mehr Datenbytes. Dieses Format ist identisch mit dem in [NTCP2](/en/docs/spec/ntcp2/) und [ECIES](/en/docs/spec/ecies/), jedoch sind die Blockdefinitionen unterschiedlich.
...
Dies verwendet dieselben 9 Bytes für den I2NP-Header wie in [NTCP2](/en/docs/spec/ntcp2/) (Typ, Nachrichten-ID, kurze Ablaufzeit).
...
- Die Padding-Länge soll entweder auf einer Pro-Nachricht-Basis entschieden werden und
  ...
  [NTCP2](/en/docs/spec/ntcp2/) bietet weitere Informationen zu diesem Thema.
