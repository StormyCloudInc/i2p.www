...
Aktualisieren Sie die Abschnitte und Tabellen im Dokument für gemeinsame Strukturen [/en/docs/specs/common-structures/](/en/docs/specs/common-structures/) wie folgt:
...
Aktualisiere die ECIES-Ratchet-Spezifikation [/en/docs/specs/ecies/](/en/docs/specs/ecies/) wie folgt:
...
Beachten Sie, dass Nachricht 2 normalerweise eine Nutzlast ungleich null haben wird, die ratchet-Spezifikation [/en/docs/specs/ecies/](/en/docs/specs/ecies/) erfordert dies jedoch nicht, sodass die minimale Nutzlastgröße 0 ist. Die minimalen Größen für Nachricht 2 können entsprechend berechnet werden.

### Signatur

Aktualisieren Sie die NTCP2-Spezifikation [/en/docs/specs/ntcp2/](/en/docs/specs/ntcp2/) wie folgt:
...
Aktualisieren Sie die SSU2-Spezifikation [/en/docs/specs/ssu2/](/en/docs/specs/ssu2/) wie folgt:
