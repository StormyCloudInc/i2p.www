...
Änderungen des 528-Byte-Datensatzformats für ECIES-X25519-Router sind in [Prop152](/en/proposals/152-ecies-tunnels/) und [Tunnel-Creation-ECIES](/en/docs/specs/tunnel-creation-ecies/) angegeben.
...
- Genügend Platz für zukünftige Optionen bereitstellen, wie in [Prop152](/en/proposals/152-ecies-tunnels/) und [Tunnel-Creation-ECIES](/en/docs/specs/tunnel-creation-ecies/)
- In eine Tunnel-Nachricht für den Rückweg passen
- Nur ECIES-Hops unterstützen
- Verbesserungen beibehalten, die in [Prop152](/en/proposals/152-ecies-tunnels/) und [Tunnel-Creation-ECIES](/en/docs/specs/tunnel-creation-ecies/) implementiert wurden
...
und 464 Byte für ECIES-Datensätze, wie in [Prop152](/en/proposals/152-ecies-tunnels/) und [Tunnel-Creation-ECIES](/en/docs/specs/tunnel-creation-ecies/) definiert.

Die unverschlüsselten Antwortsätze werden 202 Byte sein,
verglichen mit 496 Byte für ElGamal-Datensätze,
und 512 Byte für ECIES-Datensätze, wie in [Prop152](/en/proposals/152-ecies-tunnels/) und [Tunnel-Creation-ECIES](/en/docs/specs/tunnel-creation-ecies/) definiert.
...
Anforderungs- und Antwortdatensatzverschlüsselung: wie in [Prop152](/en/proposals/152-ecies-tunnels/) und [Tunnel-Creation-ECIES](/en/docs/specs/tunnel-creation-ecies/) definiert.
...
Zusammenfassung der Änderungen von [Tunnel-Creation-ECIES](/en/docs/specs/tunnel-creation-ecies/):
...
Das Flags-Feld ist dasselbe wie in [Tunnel-Creation](/en/docs/specs/tunnel-creation/) definiert und enthält die folgenden::
...
Die Tunnel-Bauoptionen sind eine Mapping-Struktur, wie in [Common](/en/docs/specs/common-structures/) definiert.
...
wie in [Tunnel-Creation](/en/docs/specs/tunnel-creation/) definiert, um Fingerprinting zu vermeiden:
