...
Giai đoạn đề xuất đã đóng. Xem [SPEC](/en/docs/specs/ntcp2/) để biết thông số kỹ thuật chính thức. Đề xuất này vẫn có thể được tham khảo để biết thông tin nền.

## Tổng quan

Đề xuất này mô tả một giao thức thỏa thuận khóa có xác thực nhằm cải thiện khả năng chống lại các hình thức nhận dạng tự động và tấn công khác nhau của [NTCP](/en/docs/transport/ntcp/).
...
- Nếu có thể, giảm bắt tay 4 tin nhắn, hai lần khứ hồi xuống bắt tay 3 tin nhắn,
  một lần khứ hồi, như trong [SSU](/en/docs/transport/ssu/). Điều này sẽ yêu cầu chuyển chữ ký
...
- Một giao thức vận chuyển dựa trên TLS (hoặc giống HTTPS)... đó sẽ là [Prop104](/en/proposals/104/).
...
Đề xuất hiện tại cố gắng cung cấp tất cả năm yêu cầu dựa trên giao thức Station-To-Station (STS). Lưu ý rằng giao thức này cũng là cơ sở cho giao thức [SSU](/en/docs/transport/ssu/).
...
Đề xuất này cung cấp các yêu cầu dựa trên Noise Protocol Framework [NOISE](https://noiseprotocol.org/noise.html) (Phiên bản 33, 2017-10-04). Noise có các đặc tính tương tự như giao thức Station-To-Station, là nền tảng cho giao thức [SSU](/en/docs/transport/ssu/). Trong thuật ngữ của Noise, Alice là bên khởi tạo và Bob là bên phản hồi.
