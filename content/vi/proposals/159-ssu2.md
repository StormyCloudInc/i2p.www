...
- Sử dụng bắt tay 3 thông điệp, một chuyến khứ hồi, như trong [NTCP2](/en/docs/spec/ntcp2/).
...
* Các mô hình đe dọa: Từ NTCP2 [NTCP2](/en/docs/spec/ntcp2/), với các đe dọa bổ sung đáng kể
...
* Lựa chọn mã hóa: Từ [NTCP2](/en/docs/spec/ntcp2/).

* Handshake: Noise XK từ [NTCP2](/en/docs/spec/ntcp2/) và [NOISE](https://noiseprotocol.org/noise.html). Các đơn giản hóa đáng kể
  cho NTCP2 có thể thực hiện được do tính đóng gói (ranh giới thông điệp vốn có)
  được cung cấp bởi UDP.

* Làm rối khóa tạm thời handshake: Điều chỉnh từ [NTCP2](/en/docs/spec/ntcp2/)
  nhưng sử dụng ChaCha20 từ [ECIES](/en/docs/spec/ecies/) thay vì AES.
...
* Che giấu header gói tin: Được điều chỉnh từ [NTCP2](/en/docs/spec/ntcp2/)
  nhưng sử dụng ChaCha20 từ [ECIES](/en/docs/spec/ecies/) thay vì AES.
...
* Headers được sử dụng làm AEAD associated data như trong [ECIES](/en/docs/spec/ecies/).
...
* Chữ ký của dữ liệu Relay và Peer Test: Từ đặc tả cấu trúc chung [Common](/en/docs/spec/common-structures/)

* Định dạng khối: Từ [NTCP2](/en/docs/spec/ntcp2/) và [ECIES](/en/docs/spec/ecies/).

* Padding và options: Từ [NTCP2](/en/docs/spec/ntcp2/) và [ECIES](/en/docs/spec/ecies/).
...
Điều này sử dụng cùng định dạng block như đã định nghĩa trong các đặc tả [NTCP2](/en/docs/spec/ntcp2/) và [ECIES](/en/docs/spec/ecies/). Các loại block riêng lẻ được định nghĩa khác nhau. Thuật ngữ tương đương trong QUIC [RFC 9000](https://datatracker.ietf.org/doc/html/rfc9000) là "frames".
...
Có một hoặc nhiều khối trong tải trọng được mã hóa. Một khối có định dạng Tag-Length-Value (TLV) đơn giản. Mỗi khối chứa một định danh một byte, một độ dài hai byte, và không hoặc nhiều byte dữ liệu. Định dạng này giống hệt với định dạng trong [NTCP2](/en/docs/spec/ntcp2/) và [ECIES](/en/docs/spec/ecies/), tuy nhiên các định nghĩa khối thì khác nhau.
...
Cách này sử dụng cùng 9 byte cho header I2NP như trong [NTCP2](/en/docs/spec/ntcp2/) (type, message id, short expiration).
...
Cái này sử dụng cùng 9 byte cho header I2NP như trong [NTCP2](/en/docs/spec/ntcp2/) (type, message id, short expiration).
...
- Độ dài padding sẽ được quyết định dựa trên từng thông điệp cụ thể và
  ...
  của [NTCP2](/en/docs/spec/ntcp2/) cung cấp thêm thông tin về chủ đề này.
