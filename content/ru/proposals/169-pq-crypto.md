...
Обновите разделы и таблицы в документе общих структур [/en/docs/specs/common-structures/](/en/docs/specs/common-structures/) следующим образом:
...
Обновить спецификацию ECIES-Ratchet [/en/docs/specs/ecies/](/en/docs/specs/ecies/) следующим образом:
...
Обратите внимание, что хотя сообщение 2 обычно будет иметь ненулевую полезную нагрузку, спецификация ratchet [/en/docs/specs/ecies/](/en/docs/specs/ecies/) этого не требует, поэтому минимальный размер полезной нагрузки составляет 0. Минимальные размеры сообщения 2 могут быть вычислены соответственно.

### Подпись

Обновить спецификацию NTCP2 [/en/docs/specs/ntcp2/](/en/docs/specs/ntcp2/) следующим образом:
...
Обновить спецификацию SSU2 [/en/docs/specs/ssu2/](/en/docs/specs/ssu2/) следующим образом:
