...
Многие проекты, такие как [ZCash](https://github.com/zcash/zips/tree/master/protocol/protocol.pdf), используют хэш-функции и
алгоритмы подписи, основанные на новых алгоритмах, которые не уязвимы к
следующим атакам.

### Атаки с расширением длины

SHA-256 и SHA-512 уязвимы к [атакам с расширением длины (LEA)](https://en.wikipedia.org/wiki/Length_extension_attack).
...
- [BLAKE2b](https://blake2.net/blake2.pdf) не уязвим для LEA.
...
- [Ed25519](http://cr.yp.to/papers.html#ed25519) требует 512-битную криптографическую хэш-функцию.
...
Использование неклассифицированного BLAKE2b-512 как в [спецификации BLAKE2](https://blake2.net/blake2.pdf) с солью и персонализацией.
...
Функции соли и персонализации не специфицированы в [RFC 7693](https://tools.ietf.org/html/rfc7693);
используйте эти функции, как специфицировано в [спецификации BLAKE2](https://blake2.net/blake2.pdf).
