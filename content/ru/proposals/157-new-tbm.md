...
См. [I2NP](/en/docs/specs/i2np/) и [Tunnel-Creation-ECIES](/en/docs/specs/tunnel-creation-ecies/) для окончательной спецификации.
...
Изменения в формате записи размером 528 байт для маршрутизаторов ECIES-X25519 специфицированы в [Prop152](/en/proposals/152-ecies-tunnels/) и [Tunnel-Creation-ECIES](/en/docs/specs/tunnel-creation-ecies/).
...
- Поддержание достаточного места для будущих опций, как в [Prop152](/en/proposals/152-ecies-tunnels/) и [Tunnel-Creation-ECIES](/en/docs/specs/tunnel-creation-ecies/)
- Вписывание в одно туннельное сообщение для обратного пути
- Поддержка только узлов ECIES
- Поддержание улучшений, реализованных в [Prop152](/en/proposals/152-ecies-tunnels/) и [Tunnel-Creation-ECIES](/en/docs/specs/tunnel-creation-ecies/)
...
и записями ECIES, определенными в [Prop152](/en/proposals/152-ecies-tunnels/) и [Tunnel-Creation-ECIES](/en/docs/specs/tunnel-creation-ecies/), которые занимают 464 байта.

Записи нешифрованного ответа будут занимать 202 байта,
по сравнению с записями ElGamal, которые занимают 496 байт,
и записями ECIES, определенными в [Prop152](/en/proposals/152-ecies-tunnels/) и [Tunnel-Creation-ECIES](/en/docs/specs/tunnel-creation-ecies/), которые занимают 512 байт.
...
Шифрование записей запроса и ответа: как определено в [Prop152](/en/proposals/152-ecies-tunnels/) и [Tunnel-Creation-ECIES](/en/docs/specs/tunnel-creation-ecies/).
...
Обзор изменений из [Tunnel-Creation-ECIES](/en/docs/specs/tunnel-creation-ecies/):
...
Поле флагов такое же как определено в [Tunnel-Creation](/en/docs/specs/tunnel-creation/) и содержит следующее:
...
Параметры построения туннеля - это структура Mapping, как определено в [Common](/en/docs/specs/common-structures/).
...
Параметры ответа на построение туннеля - это структура Mapping, как определено в [Common](/en/docs/specs/common-structures/).
Это для будущего использования. На данный момент не определено никаких параметров.
Если структура Mapping пуста, это два байта 0x00 0x00.
...
как определено в [Tunnel-Creation](/en/docs/specs/tunnel-creation/) для предотвращения фингерпринтинга:
