...
Поле флагов такое же как определено в [Tunnel-Creation](/docs/specs/tunnel-creation/) и содержит следующее:
...
как определено в [Tunnel-Creation](/docs/specs/tunnel-creation/) для предотвращения фингерпринтинга:
