...
Наши спецификации [SSU](/en/docs/transport/ssu/) и [SSU-SPEC](/en/docs/specs/ssu/) содержат ошибки и несоответствия относительно поддержки
...
Наши спецификации [SSU](/en/docs/transport/ssu/) и [SSU-SPEC](/en/docs/specs/ssu/) ясно указывают, что вводные устройства IPv6 не поддерживаются.
...
[SSU-SPEC](/en/docs/specs/ssu/) в данный момент говорит (Relay Request):
...
[SSU-SPEC](/en/docs/specs/ssu/) в данный момент говорит (Relay Response):
...
[SSU-SPEC](/en/docs/specs/ssu/) в данный момент говорит (Relay Intro):
