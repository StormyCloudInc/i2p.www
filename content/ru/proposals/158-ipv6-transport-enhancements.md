...
Наши спецификации [SSU](/docs/specs/ssu2/) и [SSU-SPEC](/docs/specs/ssu/) содержат ошибки и несоответствия относительно поддержки
...
Наши спецификации [SSU](/docs/specs/ssu2/) и [SSU-SPEC](/docs/specs/ssu/) ясно указывают, что вводные устройства IPv6 не поддерживаются.
...
[SSU-SPEC](/docs/specs/ssu/) в данный момент говорит (Relay Request):
...
[SSU-SPEC](/docs/specs/ssu/) в данный момент говорит (Relay Response):
...
[SSU-SPEC](/docs/specs/ssu/) в данный момент говорит (Relay Intro):
