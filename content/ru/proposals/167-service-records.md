...
Записи служб помещаются в секцию опций в LS2 [LS2](/en/docs/specs/common-structures/).
...
могут быть запрошены и добавлены в спецификацию общих структур [LS2](/en/docs/specs/common-structures/).
...
Протокол [I2CP](/en/docs/specs/i2cp/) должен быть расширен, чтобы поддерживать поиски служб.
