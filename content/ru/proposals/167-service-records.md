...
- target := Имя хоста или b32 адрес, предоставляющий услугу. Действительное имя хоста, как в [NAMING](/docs/naming/). Должно быть в нижнем регистре.
...
обновив [NAMING](/docs/naming/) для указания обработки имен хостов, начинающихся с '_'.
