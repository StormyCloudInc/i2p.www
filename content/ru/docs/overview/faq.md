...
Во-первых, убедитесь, что у вас установлена последняя версия всех компонентов I2P — в старых версиях были ненужные участки кода, потребляющие процессорное время. Также существует [журнал производительности](/about/performance), в котором задокументированы некоторые улучшения производительности I2P с течением времени.
