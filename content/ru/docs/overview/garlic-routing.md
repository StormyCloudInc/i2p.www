...
Для получения информации о деталях реализации туннелей см. [Спецификацию туннелей](/docs/specs/implementation) и спецификацию [Создание туннелей (ECIES)](/spec/tunnel/creation-ecies).
...
- [Создание туннелей (ECIES)](/spec/tunnel/creation-ecies) — современный протокол построения туннелей
- [Спецификация I2NP](/spec/i2np) — форматы сообщений I2NP
