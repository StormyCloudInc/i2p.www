...
Я понял. Вы не предоставили текст для перевода. Пожалуйста, предоставьте текст, и я переведу его на русский язык согласно всем указанным правилам.
...
Добро пожаловать в документацию проекта Invisible Internet Project (I2P). Здесь вы найдёте информацию о том, как установить, настроить и использовать I2P, а также техническую документацию для разработчиков.

## Начало работы

- [Установка I2P](install.md)
- [Первые шаги](first-steps.md)
- [Часто задаваемые вопросы](faq.md)

## Руководства пользователя

- [Настройка браузера](browser-config.md)
- [Использование eepsite](using-eepsites.md)
- [Электронная почта в I2P](email.md)
- [Файлообмен](file-sharing.md)

## Техническая документация

- [Обзор архитектуры сети](network-overview.md)
- [Документация по tunnel](tunnels.md)
- [Протоколы транспортного уровня](transports.md)
- [Спецификация I2NP](i2np-spec.md)
- [Руководство разработчика](developer-guide.md)

## Конфигурация и администрирование

- [Расширенная конфигурация](advanced-config.md)
- [Настройка floodfill router](floodfill-setup.md)
- [Мониторинг производительности](performance-monitoring.md)

## Участие в проекте

- [Как внести вклад](contributing.md)
- [Руководство по стилю документации](docs-style-guide.md)
- [Сообщить об ошибке](reporting-bugs.md)
