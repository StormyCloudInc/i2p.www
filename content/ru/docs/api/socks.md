...
Разработчики давно не рекомендуют использовать SOCKS для анонимного использования. Из внутренних обсуждений разработчиков и встреч 2004 года [Meeting 81](/blog/2004/03/16/i2p-dev-meeting-march-16-2004/) и [Meeting 82](/blog/2004/03/23/i2p-dev-meeting-march-23-2004/):
