...
Для разработки новых приложений смотрите [руководство по разработке приложений](/get-involved/develop/applications/).
...
- [Страница лицензий](/get-involved/develop/licenses#commit)
...
Переводчики сайта и консоли роутера: См. [Руководство для новых переводчиков](/get-involved/guides/new-translators/) для дальнейших шагов.
