...
- Usa un handshake de 3 mensajes en un solo viaje de ida y vuelta, como en [NTCP2](/en/docs/spec/ntcp2/).
...
* Modelos de amenazas: De NTCP2 [NTCP2](/en/docs/spec/ntcp2/), con amenazas adicionales significativas
...
* Opciones criptográficas: De [NTCP2](/en/docs/spec/ntcp2/).

* Handshake: Noise XK de [NTCP2](/en/docs/spec/ntcp2/) y [NOISE](https://noiseprotocol.org/noise.html). Son posibles simplificaciones significativas
  a NTCP2 debido a la encapsulación (límites de mensaje inherentes)
  proporcionada por UDP.

* Ofuscación de clave efímera de handshake: Adaptado de [NTCP2](/en/docs/spec/ntcp2/)
  pero usando ChaCha20 de [ECIES](/en/docs/spec/ecies/) en lugar de AES.
...
* Ofuscación de encabezados de paquetes: Adaptada de [NTCP2](/en/docs/spec/ntcp2/)
  pero usando ChaCha20 de [ECIES](/en/docs/spec/ecies/) en lugar de AES.
...
* Headers utilizados como datos asociados AEAD como en [ECIES](/en/docs/spec/ecies/).
...
* Firmas de datos de Relay y Peer Test: De la especificación de estructuras comunes [Common](/en/docs/spec/common-structures/)

* Formato de bloque: De [NTCP2](/en/docs/spec/ntcp2/) y [ECIES](/en/docs/spec/ecies/).

* Relleno y opciones: De [NTCP2](/en/docs/spec/ntcp2/) y [ECIES](/en/docs/spec/ecies/).
...
Esto utiliza el mismo formato de bloque definido en las especificaciones de [NTCP2](/en/docs/spec/ntcp2/) y [ECIES](/en/docs/spec/ecies/). Los tipos de bloque individuales se definen de manera diferente. El término equivalente en QUIC [RFC 9000](https://datatracker.ietf.org/doc/html/rfc9000) es "frames".
...
Hay uno o más bloques en la carga útil cifrada. Un bloque es un formato simple Tag-Length-Value (TLV). Cada bloque contiene un identificador de un byte, una longitud de dos bytes, y cero o más bytes de datos. Este formato es idéntico al de [NTCP2](/en/docs/spec/ntcp2/) y [ECIES](/en/docs/spec/ecies/), sin embargo las definiciones de bloques son diferentes.
...
Esto utiliza los mismos 9 bytes para el encabezado I2NP que en [NTCP2](/en/docs/spec/ntcp2/) (tipo, ID del mensaje, expiración corta).
...
Esto utiliza los mismos 9 bytes para el encabezado I2NP que en [NTCP2](/en/docs/spec/ntcp2/) (tipo, ID de mensaje, expiración corta).
...
- La longitud del padding debe decidirse por mensaje individual y
  ...
  de [NTCP2](/en/docs/spec/ntcp2/) proporciona más información sobre el tema.
