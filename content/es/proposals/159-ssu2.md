...
Esta propuesta describe un protocolo de acuerdo de claves autenticado para mejorar la resistencia de [SSU](/en/docs/transport/ssu/) a varias formas de identificación automatizada y ataques.
...
- Compatible con SSU 1 y 2 en un solo puerto, detección automática, y publicado como un solo
  "transport" (es decir, RouterAddress) en la [NetDB](/en/docs/how/network-database/).
...
- Usa un handshake de 3 mensajes en un solo viaje de ida y vuelta, como en [NTCP2](/en/docs/specs/ntcp2/).
  Elimina la demora de esperar mensajes de datos que hace que
  [SSU](/en/docs/transport/ssu/) sea efectivamente un handshake de dos viajes de ida y vuelta.
...
- Resistencia a DPI a prueba de balas... eso serían los transportes conectables,
  [Propuesta 109](/en/proposals/109-pt-transport/).

- Un transporte basado en TLS (o similar a HTTPS)... que sería la [Propuesta 104](/en/proposals/104-tls-transport/).
...
La presente propuesta intenta proporcionar los cinco requisitos basándose en el protocolo Station-To-Station (STS). Nótese que este protocolo también es la base para el protocolo [SSU](/en/docs/transport/ssu/).
...
* Modelos de amenazas: De NTCP2 [NTCP2](/en/docs/specs/ntcp2/), con amenazas adicionales significativas
...
* Opciones criptográficas: De [NTCP2](/en/docs/specs/ntcp2/).

* Handshake: Noise XK de [NTCP2](/en/docs/specs/ntcp2/) y [NOISE](https://noiseprotocol.org/noise.html). Son posibles simplificaciones significativas
  a NTCP2 debido a la encapsulación (límites de mensaje inherentes)
  proporcionada por UDP.

* Ofuscación de clave efímera de handshake: Adaptado de [NTCP2](/en/docs/specs/ntcp2/)
  pero usando ChaCha20 de [ECIES](/en/docs/specs/ecies/) en lugar de AES.
...
* Ofuscación de encabezados de paquetes: Adaptada de [NTCP2](/en/docs/specs/ntcp2/)
  pero usando ChaCha20 de [ECIES](/en/docs/specs/ecies/) en lugar de AES.
...
* Headers utilizados como datos asociados AEAD como en [ECIES](/en/docs/specs/ecies/).
...
* Mensajes: Adaptado de [SSU](/en/docs/transport/ssu/)

* Fragmentación I2NP: Adaptado de [SSU](/en/docs/transport/ssu/)

* Relay y Peer Testing: Adaptado de [SSU](/en/docs/transport/ssu/)

* Firmas de datos de Relay y Peer Test: De la especificación de estructuras comunes [Common](/en/docs/specs/common-structures/)

* Formato de bloque: De [NTCP2](/en/docs/specs/ntcp2/) y [ECIES](/en/docs/specs/ecies/).

* Relleno y opciones: De [NTCP2](/en/docs/specs/ntcp2/) y [ECIES](/en/docs/specs/ecies/).
...
Esta propuesta proporciona los requisitos basados en el Noise Protocol Framework [NOISE](https://noiseprotocol.org/noise.html) (Revisión 33, 2017-10-04). Noise tiene propiedades similares al protocolo Station-To-Station (STS), que es la base del protocolo [SSU](/en/docs/transport/ssu/). En la terminología de Noise, Alice es el iniciador, y Bob es el respondedor.
...
Esto utiliza el mismo formato de bloque definido en las especificaciones de [NTCP2](/en/docs/specs/ntcp2/) y [ECIES](/en/docs/specs/ecies/). Los tipos de bloque individuales se definen de manera diferente. El término equivalente en QUIC [RFC 9000](https://datatracker.ietf.org/doc/html/rfc9000) es "frames".
...
Hay uno o más bloques en la carga útil cifrada. Un bloque es un formato simple Tag-Length-Value (TLV). Cada bloque contiene un identificador de un byte, una longitud de dos bytes, y cero o más bytes de datos. Este formato es idéntico al de [NTCP2](/en/docs/specs/ntcp2/) y [ECIES](/en/docs/specs/ecies/), sin embargo las definiciones de bloques son diferentes.
...
Esto utiliza los mismos 9 bytes para el encabezado I2NP que en [NTCP2](/en/docs/specs/ntcp2/) (tipo, ID del mensaje, expiración corta).
...
Esto utiliza los mismos 9 bytes para el encabezado I2NP que en [NTCP2](/en/docs/specs/ntcp2/) (tipo, ID de mensaje, expiración corta).
...
- La longitud del padding debe decidirse por mensaje individual y
  ...
  de [NTCP2](/en/docs/specs/ntcp2/) proporciona más información sobre el tema.
...
Todas las funciones del relay SSU 1 son compatibles, incluyendo aquellas documentadas en la [Propuesta 158](/en/proposals/158-ipv6-transport-enhancements/) y soportadas desde la versión 0.9.50. Las introducciones IPv4 e IPv6 son compatibles. Una Solicitud de Relay puede enviarse a través de una sesión IPv4 para una introducción IPv6, y una Solicitud de Relay puede enviarse a través de una sesión IPv6 para una introducción IPv4.
...
Las siguientes propiedades de dirección pueden publicarse, sin cambios respecto a SSU 1, incluyendo los cambios en la [Propuesta 158](/en/proposals/158-ipv6-transport-enhancements/) soportados a partir de la API 0.9.50:
