...
Esta propuesta describe un protocolo de acuerdo de claves autenticado para mejorar la resistencia de [NTCP](/docs/transport/ntcp/) a diversas formas de identificación automatizada y ataques.
