...
Nuestras especificaciones [SSU](/docs/specs/ssu2/) y [SSU-SPEC](/docs/specs/ssu/) contienen errores e inconsistencias sobre si los presentadores IPv6 son compatibles para presentaciones IPv4.
...
Nuestras especificaciones [SSU](/docs/specs/ssu2/) y [SSU-SPEC](/docs/specs/ssu/) dejan claro que
...
[SSU-SPEC](/docs/specs/ssu/) dice actualmente (Solicitud de retransmisión):
...
[SSU-SPEC](/docs/specs/ssu/) dice actualmente (Respuesta de retransmisión):
...
[SSU-SPEC](/docs/specs/ssu/) dice actualmente (Introducción de retransmisión):
