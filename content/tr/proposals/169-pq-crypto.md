...
Ortak yapılar belgesindeki [/en/docs/specs/common-structures/](/en/docs/specs/common-structures/) bölümleri ve tabloları aşağıdaki şekilde güncelleyin:
...
ECIES-Ratchet spesifikasyonunu [/en/docs/specs/ecies/](/en/docs/specs/ecies/) aşağıdaki şekilde güncelleyin:
...
Mesaj 2'nin normalde sıfır olmayan bir payload'a sahip olacağını, ancak ratchet spesifikasyonunun [/en/docs/specs/ecies/](/en/docs/specs/ecies/) bunu gerektirmediğini, dolayısıyla minimum payload boyutunun 0 olduğunu unutmayın. Minimum mesaj 2 boyutları buna göre hesaplanabilir.

### İmza

NTCP2 spesifikasyonunu [/en/docs/specs/ntcp2/](/en/docs/specs/ntcp2/) aşağıdaki şekilde güncelleyin:
...
SSU2 spesifikasyonunu [/en/docs/specs/ssu2/](/en/docs/specs/ssu2/) aşağıdaki şekilde güncelleyin:
