...
Bu öneri, [SSU](/en/docs/transport/ssu/) protokolünün çeşitli otomatik kimlik tespit yöntemlerine ve saldırılara karşı direncini artırmak için kimlik doğrulamalı anahtar anlaşma protokolünü açıklamaktadır.
...
- Tek bir portta SSU 1 ve 2'yi destekle, otomatik algıla ve [NetDB](/en/docs/how/network-database/)'de tek bir
...
- [NTCP2](/en/docs/specs/ntcp2/)'de olduğu gibi 3 mesajlı, tek gidiş-dönüş el sıkışması kullanın.
  [SSU](/en/docs/transport/ssu/)'yu etkili bir şekilde iki gidiş-dönüş el sıkışması haline getiren
...
- TLS tabanlı (veya HTTPS benzeri) bir taşıma protokolü... bu [Proposal 104](/en/proposals/104-tls-transport/) olurdu.
...
Bu önerme, Station-To-Station (STS) protokolü temelinde beş gereksinimin tamamını sağlamaya çalışmaktadır. Bu protokolün aynı zamanda [SSU](/en/docs/transport/ssu/) protokolünün de temelini oluşturduğunu unutmayın.
...
* Tehdit modelleri: NTCP2 [NTCP2](/en/docs/specs/ntcp2/)'den, QUIC [RFC 9000](https://datatracker.ietf.org/doc/html/rfc9000) [RFC 9001](https://datatracker.ietf.org/doc/html/rfc9001) tarafından analiz edilen UDP taşıma ile ilgili önemli ek tehditlerle birlikte.

* Kriptografik seçimler: [NTCP2](/en/docs/specs/ntcp2/)'den.

* Handshake: [NTCP2](/en/docs/specs/ntcp2/) ve [NOISE](https://noiseprotocol.org/noise.html)'dan Noise XK. UDP tarafından sağlanan kapsülleme (doğal mesaj sınırları) nedeniyle NTCP2'de önemli basitleştirmeler mümkündür.

* Handshake ephemeral key obfuscation: [NTCP2](/en/docs/specs/ntcp2/)'den uyarlanmıştır
  ancak AES yerine [ECIES](/en/docs/specs/ecies/)'den ChaCha20 kullanmaktadır.
...
* Paket başlığı gizleme: [NTCP2](/en/docs/specs/ntcp2/)'den uyarlanmıştır
  ancak AES yerine [ECIES](/en/docs/specs/ecies/)'den ChaCha20 kullanır.
...
* [ECIES](/en/docs/specs/ecies/) içindeki gibi AEAD ilişkili veri olarak kullanılan başlıklar.
...
* Mesajlar: [SSU](/en/docs/transport/ssu/) protokolünden uyarlanmıştır

* I2NP Fragmentasyonu: [SSU](/en/docs/transport/ssu/) adresinden uyarlanmıştır

* Relay ve Peer Testing: [SSU](/en/docs/transport/ssu/) adresinden uyarlanmıştır

* Relay ve Peer Test verilerinin İmzaları: Ortak yapılar spesifikasyonundan [Common](/en/docs/specs/common-structures/)

* Blok formatı: [NTCP2](/en/docs/specs/ntcp2/) ve [ECIES](/en/docs/specs/ecies/) protokollerinden.

* Dolgu ve seçenekler: [NTCP2](/en/docs/specs/ntcp2/) ve [ECIES](/en/docs/specs/ecies/)'den.
...
Bu öneri, Noise Protocol Framework [NOISE](https://noiseprotocol.org/noise.html) (Revizyon 33, 2017-10-04) temel alınarak hazırlanmış gereksinimleri sağlar. Noise, [SSU](/en/docs/transport/ssu/) protokolünün temelini oluşturan Station-To-Station (STS) protokolü ile benzer özelliklere sahiptir. Noise terminolojisinde Alice başlatıcı, Bob ise yanıtlayıcıdır.
...
Bu, [NTCP2](/en/docs/specs/ntcp2/) ve [ECIES](/en/docs/specs/ecies/) spesifikasyonlarında tanımlanan aynı blok formatını kullanır. Bireysel blok türleri farklı şekilde tanımlanır. QUIC [RFC 9000](https://datatracker.ietf.org/doc/html/rfc9000)'de karşılık gelen terim "frames"'dir.
...
Şifrelenmiş yük içinde bir veya daha fazla blok bulunur. Bir blok basit bir Tag-Length-Value (TLV) formatıdır. Her blok bir byte'lık tanımlayıcı, iki byte'lık uzunluk ve sıfır veya daha fazla byte veri içerir. Bu format [NTCP2](/en/docs/specs/ntcp2/) ve [ECIES](/en/docs/specs/ecies/) ile aynıdır, ancak blok tanımları farklıdır.
...
Bu, [NTCP2](/en/docs/specs/ntcp2/) ile aynı 9 bayt I2NP başlığını kullanır (tip, mesaj kimliği, kısa süre sonu).
...
Bu, [NTCP2](/en/docs/specs/ntcp2/) ile aynı 9 baytlık I2NP başlığını kullanır (tür, mesaj id'si, kısa süre sonu).
...
Aşağıdaki adres özellikleri, API 0.9.50 itibariyle desteklenen [Proposal 158](/en/proposals/158-ipv6-transport-enhancements/)'deki değişiklikler dahil olmak üzere, SSU 1'den değiştirilmeden yayınlanabilir:
