...
- **문서 읽기**: 자세한 내용은 [I2P 문서](../../_index.md)를 확인하세요
...
- **포트 포워딩 구성**: 설정 방법은 [포트 포워딩 가이드](windows-easy-install.md#recommended-port-forwarding-optional-but-important)를 참조하세요
...
- **문서 읽기**: 자세한 정보는 [I2P 문서](../../_index.md)를 확인하세요
