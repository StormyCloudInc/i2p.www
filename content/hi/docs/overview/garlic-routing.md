...
टनल कार्यान्वयन विवरण के लिए, [Tunnel Specification](/docs/specs/implementation) और [Tunnel Creation (ECIES)](/spec/tunnel/creation-ecies) स्पेसिफिकेशन देखें।
...
- [Tunnel Creation (ECIES)](/spec/tunnel/creation-ecies) — आधुनिक tunnel निर्माण प्रोटोकॉल
- [I2NP Specification](/spec/i2np) — I2NP संदेश प्रारूप
