...
देखें the [ECIES specification](/en/docs/specs/ecies/#overhead), [Streaming specification](/en/docs/specs/streaming/#flags-and-option-data-fields), and [Streaming API documentation](/en/docs/api/streaming/)।
...
जैसा कि the [Streaming API documentation](/en/docs/api/streaming/) में उल्लेख किया गया है,
...
जैसा कि the [ECIES specification](/en/docs/specs/ecies/#overhead) में वर्णित है, मौजूदा सत्र संदेशों के लिए ElGamal ओवरहेड
...
MTU चयन और समुच्चयन अनुभाग में निम्नलिखित परिवर्तन और स्पष्टीकरण जोड़ें the [Streaming API documentation](/en/docs/api/streaming/)।
the [Streaming specification](/en/docs/specs/streaming/) में कोई परिवर्तन नहीं।
...
देखें the [ECIES specification](/en/docs/specs/ecies/#overhead) ECIES ओवरहेड क्यों ElGamal से 82 बाइट्स कम है।
