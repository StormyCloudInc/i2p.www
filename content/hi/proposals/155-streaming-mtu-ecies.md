...
देखें the [ECIES specification](/en/docs/spec/ecies/#overhead), [Streaming specification](/en/docs/spec/streaming/#flags-and-option-data-fields), and [Streaming API documentation](/en/docs/api/streaming/)।
...
जैसा कि the [ECIES specification](/en/docs/spec/ecies/#overhead) में वर्णित है, मौजूदा सत्र संदेशों के लिए ElGamal ओवरहेड
...
the [Streaming specification](/en/docs/spec/streaming/) में कोई परिवर्तन नहीं।
...
देखें the [ECIES specification](/en/docs/spec/ecies/#overhead) ECIES ओवरहेड क्यों ElGamal से 82 बाइट्स कम है।
