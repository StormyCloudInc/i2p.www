...
- ECIES राउटर्स 0.9.48 के तहत कार्यान्वित, देखें [Common](/en/docs/specs/common-structures/)।
- टनल निर्माण 0.9.48 के तहत कार्यान्वित, देखें [Tunnel-Creation-ECIES](/en/docs/specs/tunnel-creation-ecies/)।
- ECIES राउटर्स को एन्क्रिप्टेड संदेश 0.9.49 के तहत कार्यान्वित, देखें [ECIES-ROUTERS](/en/docs/specs/ecies-routers/)।
...
LS2 [Prop123](/en/proposals/123-new-netdb-entries/) और ECIES-X25519-AEAD-Ratchet [Prop144](/en/proposals/144-ecies-x25519-aead-ratchet/) (अब [ECIES](/en/docs/specs/ecies/) में निर्दिष्ट) के लिए प्रस्ताव
...
राउटर के लिए इसकी कोई आवश्यकता नहीं है। राउटर की एन्क्रिप्शन कुंजी इसकी राउटर पहचान में है। साझा संरचना विशिष्टता देखें [Common](/en/docs/specs/common-structures/)।
...
यह साझा संरचनाओं के निर्दिष्ट मानक निर्माण के समान है [Common](/en/docs/specs/common-structures/)।
...
टनल निर्माण विनिर्देशन [Tunnel-Creation](/en/docs/specs/tunnel-creation/) में कई परिवर्तन आवश्यक हैं ताकि ECIES के बजाय ElGamal का उपयोग किया जा सके।
...
ECIES-X25519-AEAD-Ratchet [Prop144](/en/proposals/144-ecies-x25519-aead-ratchet/) में, अब [ECIES](/en/docs/specs/ecies/) में निर्दिष्ट किया गया है।
...
- गंतव्यों के लिए [ECIES](/en/docs/specs/ecies/) में वर्णित "ड्यूल की" सेशन की मैनेजर्स चलाने की कोई आवश्यकता नहीं है। राउटरों के पास केवल एक ही सार्वजनिक कुंजी है।

#### डिजाइन निष्कर्ष

ECIES राउटर SKM को गंतव्यों के लिए [ECIES](/en/docs/specs/ecies/) में निर्दिष्ट एक पूर्ण रैचेट SKM की आवश्यकता नहीं है।
...
यह गंतव्यों के लिए [ECIES](/en/docs/specs/ecies/) में निर्दिष्ट पेलोड प्रारूप का उपयोग करेगा।
...
यह [Prop154](/en/proposals/154-ecies-lookups/), अब[I2NP](/en/docs/specs/i2np/) में निर्दिष्ट है में प्रलेखित है।
...
X25519: देखें [ECIES](/en/docs/specs/ecies/)।

राउटर पहचान और कुंजी प्रमाणपत्र: देखें [Common](/en/docs/specs/common-structures/)।
...
अनुरोध एन्क्रिप्शन वही है जैसा कि [Tunnel-Creation-ECIES](/en/docs/specs/tunnel-creation-ecies/) और [Prop152](/en/proposals/152-ecies-tunnels/) में निर्दिष्ट है,
...
जैसा कि [I2NP](/en/docs/specs/i2np/) और [Prop154](/en/proposals/154-ecies-lookups/) में निर्दिष्ट है। उत्तर को एन्क्रिप्ट करने के लिए कुंजी और टैग का उपयोग किया जाता है।

टैग सेट नहीं बनाए जाते हैं।
शून्य स्थिर कुंजी योजना निर्दिष्ट 
ECIES-X25519-AEAD-Ratchet [Prop144](/en/proposals/144-ecies-x25519-aead-ratchet/) और [ECIES](/en/docs/specs/ecies/) में उपयोग नहीं किया जाएगा।
...
यह वही है जैसा कि सुरंग निर्माण संदेशों के लिए [Tunnel-Creation-ECIES](/en/docs/specs/tunnel-creation-ecies/) और [Prop152](/en/proposals/152-ecies-tunnels/) में निर्दिष्ट है।
...
पेलोड वही ब्लॉक प्रारूप है जैसा कि [ECIES](/en/docs/specs/ecies/) और [Prop144](/en/proposals/144-ecies-x25519-aead-ratchet/) में परिभाषित किया गया है।
...
जैसा कि [I2NP](/en/docs/specs/i2np/) और [Prop154](/en/proposals/154-ecies-lookups/) में निर्दिष्ट 32-बाइट उत्तर कुंजी और 8-बाइट उत्तर टैग के साथ एन्क्रिप्ट किए जाते हैं।
