...
कई प्रोजेक्ट्स, जैसे [ZCash](https://github.com/zcash/zips/tree/master/protocol/protocol.pdf), नए एल्गोरिदम पर आधारित हैश फंक्शंस और हस्ताक्षर एल्गोरिदम का उपयोग कर रहे हैं जो निम्नलिखित हमलों के लिए असुरक्षित नहीं हैं।

### लंबाई विस्तार हमले

SHA-256 और SHA-512 [लंबाई विस्तार हमलों (LEA)](https://en.wikipedia.org/wiki/Length_extension_attack) के लिए असुरक्षित हैं। यह तब होता है जब वास्तविक डेटा की बजाय डेटा का हैश हस्ताक्षरित होता है। अधिकांश I2P प्रोटोकॉल्स (स्ट्रीमिंग, डाटाग्राम्स, नेटडब, और अन्य) में, वास्तविक डेटा हस्ताक्षरित होता है। एक अपवाद SU3 फाइल्स है, जहां हैश हस्ताक्षरित होता है। दूसरा अपवाद डीएसए के लिए हस्ताक्षरित डाटाग्राम (सिग टाइप 0) ही है, जहां हैश हस्ताक्षरित होता है। अन्य हस्ताक्षरित डाटाग्राम सिग टाइप्स के लिए, डेटा हस्ताक्षरित होता है।
...
- [BLAKE2b](https://blake2.net/blake2.pdf) LEA के लिए असुरक्षित नहीं है।
...
- BLAKE2b आधुनिक हार्डवेयर पर SHA-256 और SHA-512 (और MD5) से तेज है, [BLAKE2 विनिर्देशन](https://blake2.net/blake2.pdf) के अनुसार।
- Ed25519 अब भी हमारा सबसे तेज हस्ताक्षर प्रकार है, कम से कम जावा में ECDSA से कहीं तेज।
- [Ed25519](http://cr.yp.to/papers.html#ed25519) के लिए 512 बिट क्रिप्टोग्राफिक हैश फंक्शन की आवश्यकता होती है। यह SHA-512 को निर्दिष्ट नहीं करता है। BLAKE2b हैश फंक्शन के लिए उतना ही उपयुक्त है।
- BLAKE2b कई प्रोग्रामिंग भाषाओं के लिए लाइब्रेरीज़ में व्यापक रूप से उपलब्ध है, जैसे कि Noise।

## विनिर्देशन

साल्ट और निजीकरण के साथ [BLAKE2 विनिर्देशन](https://blake2.net/blake2.pdf) में बिना कुंजी के BLAKE2b-512 का उपयोग करें। सभी BLAKE2b हस्ताक्षरों के उपयोग के लिए एक 16-अक्षर की निजीकरण स्ट्रिंग का उपयोग किया जाएगा।
...
साल्ट और निजीकरण विशेषताएँ [RFC 7693](https://tools.ietf.org/html/rfc7693) में निर्दिष्ट नहीं हैं; उन विशेषताओं का उपयोग [BLAKE2 विनिर्देशन](https://blake2.net/blake2.pdf) में निर्दिष्ट के रूप में करें।
...
- वैकल्पिक 2: RFC 8032 में Ed25519ctx; LEA प्रतिरोध और निजीकरण प्रदान करता है। मानकीकृत, लेकिन क्या कोई इसका उपयोग करता है? देखें [RFC 8032](https://tools.ietf.org/html/rfc8032) और [यह चर्चा](https://moderncrypto.org/mail-archive/curves/2017/000925.html)।
