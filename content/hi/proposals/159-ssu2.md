...
यह प्रस्ताव एक प्रमाणित key agreement प्रोटोकॉल का वर्णन करता है जो [SSU](/en/docs/transport/ssu/) की स्वचालित पहचान और हमलों के विभिन्न रूपों के प्रतिरोध को बेहतर बनाने के लिए है।
...
- एक ही port पर SSU 1 और 2 को support करें, auto-detect करें, और [NetDB](/en/docs/how/network-database/) में एक single
...
- एक 3-संदेश, एक-round-trip handshake का उपयोग करें, जैसा कि [NTCP2](/en/docs/specs/ntcp2/) में है।
  डेटा संदेशों की प्रतीक्षा में होने वाली देरी को हटाएं जो
  [SSU](/en/docs/transport/ssu/) को प्रभावी रूप से एक two-round-trip handshake बनाती है।
...
- एक TLS-based (या HTTPS-lookalike) transport... जो [Proposal 104](/en/proposals/104-tls-transport/) होगा।
...
वर्तमान प्रस्ताव Station-To-Station (STS) protocol Station-To-Station (STS) protocol के आधार पर सभी पांच आवश्यकताओं को प्रदान करने का प्रयास करता है। ध्यान दें कि यह protocol [SSU](/en/docs/transport/ssu/) protocol का भी आधार है।
...
* खतरा मॉडल: NTCP2 [NTCP2](/en/docs/specs/ntcp2/) से, UDP परिवहन के लिए प्रासंगिक महत्वपूर्ण अतिरिक्त खतरों के साथ जैसा कि QUIC [RFC 9000](https://datatracker.ietf.org/doc/html/rfc9000) [RFC 9001](https://datatracker.ietf.org/doc/html/rfc9001) द्वारा विश्लेषित किया गया है।

* क्रिप्टोग्राफिक विकल्प: [NTCP2](/en/docs/specs/ntcp2/) से।

* हैंडशेक: [NTCP2](/en/docs/specs/ntcp2/) और [NOISE](https://noiseprotocol.org/noise.html) से Noise XK। UDP द्वारा प्रदान किए गए encapsulation (अंतर्निहित संदेश सीमाएं) के कारण NTCP2 में महत्वपूर्ण सरलीकरण संभव हैं।

* Handshake ephemeral key obfuscation: [NTCP2](/en/docs/specs/ntcp2/) से अनुकूलित
  लेकिन AES के बजाय [ECIES](/en/docs/specs/ecies/) से ChaCha20 का उपयोग करते हुए।
...
* Packet header obfuscation: [NTCP2](/en/docs/specs/ntcp2/) से अनुकूलित
  लेकिन AES के बजाय [ECIES](/en/docs/specs/ecies/) से ChaCha20 का उपयोग करते हुए।
...
* Headers का उपयोग AEAD associated data के रूप में किया जाता है जैसा कि [ECIES](/en/docs/specs/ecies/) में है।
...
* Messages: [SSU](/en/docs/transport/ssu/) से अनुकूलित

* I2NP Fragmentation: [SSU](/en/docs/transport/ssu/) से अनुकूलित

* रिले और पीयर टेस्टिंग: [SSU](/en/docs/transport/ssu/) से अनुकूलित

* Relay और Peer Test डेटा के हस्ताक्षर: सामान्य संरचना विनिर्देश से [Common](/en/docs/specs/common-structures/)

* ब्लॉक प्रारूप: [NTCP2](/en/docs/specs/ntcp2/) और [ECIES](/en/docs/specs/ecies/) से।

* Padding और options: [NTCP2](/en/docs/specs/ntcp2/) और [ECIES](/en/docs/specs/ecies/) से।
...
यह प्रस्ताव Noise Protocol Framework [NOISE](https://noiseprotocol.org/noise.html) (संशोधन 33, 2017-10-04) पर आधारित आवश्यकताओं को प्रदान करता है। Noise के गुण Station-To-Station protocol Station-To-Station (STS) protocol के समान हैं, जो [SSU](/en/docs/transport/ssu/) protocol का आधार है। Noise की भाषा में, Alice initiator है, और Bob responder है।
...
यह वही block format का उपयोग करता है जो [NTCP2](/en/docs/specs/ntcp2/) और [ECIES](/en/docs/specs/ecies/) specifications में परिभाषित है। Individual block types अलग तरीके से परिभाषित हैं। QUIC [RFC 9000](https://datatracker.ietf.org/doc/html/rfc9000) में समकक्ष शब्द "frames" है।
...
एन्क्रिप्टेड payload में एक या अधिक ब्लॉक होते हैं। एक ब्लॉक एक सरल Tag-Length-Value (TLV) प्रारूप है। प्रत्येक ब्लॉक में एक one-byte identifier, एक two-byte length, और शून्य या अधिक bytes का डेटा होता है। यह प्रारूप [NTCP2](/en/docs/specs/ntcp2/) और [ECIES](/en/docs/specs/ecies/) के समान है, हालांकि ब्लॉक definitions भिन्न हैं।
...
यह [NTCP2](/en/docs/specs/ntcp2/) की तरह ही I2NP header के लिए समान 9 bytes का उपयोग करता है (type, message id, short expiration)।
...
यह [NTCP2](/en/docs/specs/ntcp2/) के समान I2NP header के लिए 9 bytes का उपयोग करता है (type, message id, short expiration)।
...
- पैडिंग की लंबाई या तो प्रति-संदेश आधार पर निर्णय लेने और
  ...
  प्रोटोकॉल द्वारा ले जाया जा रहा है। सटीक पैडिंग स्कीम भविष्य के कार्य का एक क्षेत्र है, [NTCP2](/en/docs/specs/ntcp2/) का परिशिष्ट A
...
निम्नलिखित address properties प्रकाशित की जा सकती हैं, SSU 1 से अपरिवर्तित, जिसमें [Proposal 158](/en/proposals/158-ipv6-transport-enhancements/) में परिवर्तन शामिल हैं जो API 0.9.50 से समर्थित हैं:
